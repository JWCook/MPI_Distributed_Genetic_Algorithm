...
config.h:	Configurable parameters and program defaults
types.h:	Data structures used for this program
ga.c:		Main loop of program and genetic operators
fitness.c:	Fitness functions and associated helper methods
init.c:		Initialization and validation of starting populations
mt_mpi:		Parallel implementation of the Mersenne Twister RNG algorithm
report.c:	Helper functions for reporting population and fitness stats
